# Программа(две версии), генерирующая owl-файл (онтологию) на основе csv-файла, содержащего пары терминов (имен классов) с указанием типа связи для каждой пары.
